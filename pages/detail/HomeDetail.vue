<template>
  <div class="home-detail">
    ...
    <div class="event-detail section-temp">
      <div class="event-detail-top container" v-for="(item,index) in upcommingData" :key="index">
        <div class="col-md-16 event-detail-text">
          <div class="celendar">
            <div class="celendar-month">Tháng 2</div>
            <div class="celendar-day">18</div>
          </div>
          ...
          <div class="organizer">
            Diễn giả:
            <span class="organizer-name text-bold"> Ông Nguyễn Văn Thức </span>
          </div>
        ...
        <div class="col-md-7 event-detail-card">
          <div class="ed-card-ctn">
            <div id="Time">18/02/2023 - 08:30 AM</div>
            <div id="Location">
              Trung tâm Hội nghị TP. Hải Phòng - Phòng 303, tầng 3 số 18 Hoàng
              Diệu, Minh Khai, Hồng Bàng, Hải Phòng
            </div>
        ...
        <div class="col-md-24">
          ...
          <div class="cb-ctn">
            <div>
              <div>
                <img
                  src="~/static/images/detail/ic-benefit-content-4.svg"
                  alt="AMIS Event"
                />
              </div>
              <div>
